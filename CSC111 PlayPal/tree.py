...
class GameTree:
    ...
    #  - _subtrees: The subtrees. str refers to the name of the game or the name of the parameter
    _subtrees: dict  # dict[str, GameTree]
    ...
    def insert_game(self, subtree: GameTree) -> None:
        """Add a game to this game tree."""
